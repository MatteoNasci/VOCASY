...
public class SettingsTest
{
    ...
    [Test]
    public void TestConstMaxFrequency()
    {
        Assert.That(settings.MaxFrequency, Is.EqualTo(48000));
    }
    [Test]
    public void TestConstMinFrequency()
    {
        Assert.That(settings.MinFrequency, Is.EqualTo(12000));
    }
    [Test]
    public void TestConstMaxChannels()
    {
        Assert.That(settings.MaxChannels, Is.EqualTo(2));
    }
    [Test]
    public void TestConstMinChannels()
    {
        Assert.That(settings.MinChannels, Is.EqualTo(1));
    }
    [Test]
